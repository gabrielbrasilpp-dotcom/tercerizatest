    ...
    <head>
      ...
      <style>
        ...
        * { box-sizing: border-box; margin: 0; padding: 0; font-family: -apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, Helvetica, Arial, sans-serif; }
        ...
        /* Fundo com tratamento de escurecimento perfeito para leitura */
        .bg-overlay {
          position: fixed;
          top: 0; left: 0; width: 100%; height: 100%;
          background: linear-gradient(180deg, rgba(9, 13, 22, 0.95) 0%, rgba(15, 23, 42, 0.92) 100%),
        ...
        .logo { font-size: 1.35rem; font-weight: 800; color: var(--text-main); text-decoration: none; display: flex; align-items: center; gap: 10px; }
        .logo-icon { background: var(--accent); color: #fff; padding: 6px 10px; border-radius: 8px; font-size: 0.95rem; box-shadow: 0 0 15px rgba(234, 88, 12, 0.4); }
        ...
        .region-card label { display: block; font-size: 0.95rem; font-weight: 700; margin-bottom: 10px; color: var(--text-main); }
        .region-select {
          width: 100%;
          padding: 12px 14px;
        ...
        .btn:hover { background: var(--accent-hover); transform: translateY(-2px); box-shadow: 0 6px 20px rgba(234, 88, 12, 0.6); }
        ...
        .bottom-nav a { display: flex; flex-direction: column; align-items: center; gap: 3px; text-decoration: none; color: var(--text-muted); font-size: 0.75rem; font-weight: 600; transition: 0.2s; }
    ...
    <body>
      ...
      <header>
        ...
        <div class="header-actions">
          ...
          <a href="/auth/login" style="font-size: 0.9rem; font-weight: 700; color: var(--text-main); text-decoration: none; padding: 8px 14px; background: var(--card-border); border-radius: 8px;">Entrar</a>
        </div>
      </header>
...
app.listen(PORT, () => {
  console.log(`🚀 Tercereiza rodando na porta ${PORT} com design corporativo limpo e alto contraste!`);
});
